  ...
  return (
    ...
    >
      <div className="max-w-screen-lg px-4 justify-center mx-auto w-full h-full">
        <div>
          <h1
            className="text-white inline border-gray-500   font-bold border-b-2
           text-4xl"
          >
            Contact
          </h1>
        ...
        <div>
          ...
          >
            ...
            <button
              type="submit"
              className="bg-gradient-to-r w-40 px-4 py-3 my-4 items-center  rounded-md from-blue-600 to-blue-500 text-white text-xl capitalize "
            >
              Send message
            </button>
          </form>
